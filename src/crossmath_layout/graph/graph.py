...
from crossmath_layout.graph.edge import Edge
...
if __name__ == "__main__":
    ...
    from crossmath_layout.common.generic_search import bfs, Node, node_to_path
    bfs_result: Optional[Node[str]] = bfs("Boston", lambda x: x == "Miami",
